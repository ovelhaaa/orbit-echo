...
- **DC BLOCK ENABLE** (`ap.dcBlockEnabled`) — apenas valor inicial publicado no boot; sem controle na UI.
- **READ MODE** (`ap.readMode`) — apenas valor inicial no boot (`Accidental`); sem controle na UI.
